...
!function(){
	...
	var c1=[-250, 40], c2=[-50, 325], c3=[-10, 370]; //Column positions of labels.
	var colors =['#a6cee3','#1f78b4','#b2df8a','#33a02c',"#984ea3","#a65628",'#fb9a99','#e31a1c','#fdbf6f','#ff7f00','#cab2d6','#6a3d9a','#ffff99','#b15928'];
